...
Gli passo la stringa $011$. L'automa interpreta la stringa come segue:$$\begin{aligned}(q_{1}, 011)&\implies \vdash_M (q_{1}, 11)\\ &\implies \vdash_M (q_2, 1)\\ &\implies \vdash_M (q_2, \varepsilon)\\ \mathcal{E}&=\text{Stringa Vuota}\end{aligned}$$ Quindi:$$(q_1, 011) \vdash_M^* (q_2, \varepsilon)$$ che è equivalente al dire che:$$\delta^*(q_1, 011) = (q_2, \varepsilon)$$ Essendo $q_{2} \in F$, vuol dire che la stringa $011$ è accettata dall'automa, quindi: $w=011 \in L(M).$
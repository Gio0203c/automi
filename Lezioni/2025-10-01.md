...
Caso semplice: $N_{0}$ $\mathcal{E}-\text{archi}$. Allora avremo:
- $Q_{D}=\mathcal P(Q_{N})$
- $q_{0}^{D}=\{q_{0}^{N} \}$
- $F_{D}=\{R\in Q_{D}:R_{1}F_{N}\neq\emptyset \}$. $R$ contiene uno stato finale di $Q_{N}$.
...
Di fatto $D$ sta emulando deterministicamente tutti i rami di computazione non-det. di $N.$
